...
публикации, а plugin до загрузки package требует отдельное прямое согласие
пользователя в защищённой локальной форме. Новая публикация всегда требует
нового согласия, даже если package bytes не изменились.
