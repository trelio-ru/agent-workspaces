...
Вход в Trelio при необходимости и подтверждение доступа проходят в этом одном
окне: возвращаться в чат между ними не нужно. Завершите личный OAuth в браузере.
Агент сначала продолжит настройку в текущей задаче; новая нужна только если
инструменты в ней фактически не появились.
