...
редактируемый комментарий с действием публикации, но не публикует его сам и не
останавливает из-за него Run. Пока предложение не опубликовано, следующий
вариант заново кратко описывает суть изменений после последнего опубликованного
комментария, а не склеивает старые тексты. Перед записью агент сохраняет handoff
с итогом, подтверждениями, подготовленными материалами, открытыми вопросами и
следующим действием.
