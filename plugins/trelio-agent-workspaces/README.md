...
Git-оболочку хоста, в том числе с проверенными техническими снимками Codex без
истории и пользовательских файлов, onboarding безопасно переименует в уникальную
резервную копию без отдельного вопроса и сообщит её путь в итоге настройки;
существующий или неоднозначный репозиторий не меняет и
