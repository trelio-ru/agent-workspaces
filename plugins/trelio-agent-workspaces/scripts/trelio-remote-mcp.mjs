...
export const AGENT_SKILL_ROUTING_INSTRUCTIONS = [
  ...
  "Fallback is allowed only when the exact catalog has no relevant skill, its required connection is not configured, or the operation is unsupported; state that exact reason. Unavailable `list_agent_skills` / `get_agent_skill` means the skill control plane is unavailable, not that the integration is absent.",
