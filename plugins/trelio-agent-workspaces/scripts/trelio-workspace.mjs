...
export const BRIDGE_VERSION = "2.0.4";
...
export const buildAgentWorkspaceRuntimeAgentsMarkdown = (
  ...
  "## Маршрутизация",
  "",
  "- Bridge action выполняй через `continue_trelio_workspace_action` с returned `operation`/`parameters` и exact рабочей папкой, без shell-команды. Для поиска контекста, внешнего runtime, Agent Secrets и proposals лениво загружай exact skill reference.",
  ...
  "- После coherent file change выполни action `checkpoint` с `type=draft`, opened directory и `summary`; также до ожидания, границы реплики/сессии, compaction или передачи. Не сохраняй незавершённый или пустой checkpoint.",
