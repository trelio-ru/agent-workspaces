...
каталога не требуют, если для задачи нет правдоподобной reusable procedure или
подключённого сервиса.

После содержательного результата интеграции до финального ответа выполни
[проверку сохранения контекста](workspace-context-review.md), в том числе
без открытого Run или выбранной задачи. Успешный поиск ещё не подтверждает
фиксацию найденного.
