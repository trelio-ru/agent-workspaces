...
Если реестр только упоминает оригинальное имя/путь, сделай один поиск этого
точного имени в текущей компании и выбери актуальный file locator. Для выдачи
одного оригинала весь реестр или Workspace разворачивать не требуется. Несколько
конкурирующих файлов сравни по scope и metadata, не угадывай. Более широкое ревью
принятых материалов использует процедуру ниже.
