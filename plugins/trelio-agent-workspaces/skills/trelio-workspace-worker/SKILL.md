...
9. If the bridge reports that login is required, tell the user OAuth consent is opening, run `trelio-workspace login`, and continue after consent. This is the only expected interactive setup.
