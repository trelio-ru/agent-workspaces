...
SKILL_ID = "1c-edo"
# The implementation intentionally remains the audited runtime 1.0.5 code
# from skill release 1.0.6.  Only the release identity moves forward so a
# client never sees an apparent downgrade after the temporary shared-runtime
# releases 1.0.7–1.0.12.
